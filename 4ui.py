...
x1 = [1,1.5,2,2.5,3,3.5,6,8] 
y1 = [1.7,2.1,2.9,3.3,4.2,5,7,8.5]

window = tk.Tk()

window.title("Plant Leaf Disease Predicition")
...
x2 = [1.1,1.25,2.1,2.56,3.1,3.56,5.1,6.2,7.2,8.3] 
y2 = [1.3,1.7,2.4,3.6,4.1,4.6,5.7,6.8,8.7,8.9] 
def bact():
    window.destroy()
    window1 = tk.Tk()
...
def analysis():
    ...
    verify_dir = 'C:/Users/Acer/Desktop/SOURCE CODE/test/test'
    IMG_SIZE = 50
    LR = 1e-3
...
def openphoto():
    dirPath = "C:/Users/Acer/Desktop/SOURCE CODE/test/test"
    ...
    fileName = askopenfilename(initialdir='E:\\PYTHON PROJECTS BACKUPS\\17.Leaf Disease Prediction Using OpenCV-Python\\SOURCE CODE\\test\\', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:/Users/Acer/Desktop/SOURCE CODE/test/test"
